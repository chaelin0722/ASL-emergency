...
const storage = multer.diskStorage({
  destination: function (req, file, cb) {
    cb(null, "/Users/zzenninkim/Documents/Research/asl-emergency/asl-website/recorded-videos");
  },
...
app.post("/process-video", (req, res) => {
  ...
  // define values
  const videoDir = "/Users/zzenninkim/Documents/Research/asl-emergency/asl-website/recorded-videos";
  const videoPath = path.join(videoDir, req.body.filename);
  const jsonPath = path.join(videoDir, "recorded-video.json");

  // run python code
  const python = spawn("python3", [
    "/Users/zzenninkim/Documents/Research/asl-emergency/model/ST-GCN/model.py",
    "--video",
    videoPath,
  ]);
